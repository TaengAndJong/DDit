...
//      }
   ...
   static public int intro2() {
      int t12 = 0, n12 = 0, n22 = 0, n32 = 0, n42 = 0, n52 = 0;
      String pressEnter = "";
      String[] team1 = { "T■","T■", "T■■", "T■■",  "T■■■", "T■■■",  "T■■■E", "T■■■E", "T■■E", "T■■E", "T■E", "T■E", 
            "TE", "TE", "TE■","TE■","TE■■","TE■■","TE■■■","TE■■■","TE■■■A","TE■■■A","TE■■A","TE■■A","TE■A","TE■A","TEA","TEA",
            "TEA■","TEA■","TEA■■","TEA■■","TEA■■■M", "TEA■■M", "TEA■■M", "TEA■M", "TEA■M", "TEAM", "TEAM", "TEAM■", 
            "TEAM■", "TEAM2", "TEAM2","■■■■■", "■■■■■", "TEAM2", "TEAM2","■■■■■", "■■■■■","TEAM2", "TEAM2" };
         ...
         for (int i = 0; i < team1.length; i++) {
            ...
            team_1 = team1[j];
//            if (i >= team1.length) {
//               if (n12 > name1.length - 1)
//                  n12 = name1.length - 1;
//               name_1 = name1[n12++];
//            }
//            if (i >= team1.length + name1.length) {
//               if (n22 > name2.length - 1) 
//                  n22 = name2.length - 1;
//               name_2 = name2[n22++];
//            }
//            if (i >= team1.length + name1.length + name2.length) {
//               if (n32 > name3.length - 1) 
//                  n32 = name3.length - 1;
//               name_3 = name3[n32++];
//            }
//            if (i >= team1.length + name1.length + name2.length + name3.length) {
//               if (n42 > name4.length - 1) 
//                  n42 = name4.length - 1;
//               name_4 = name4[n42++];
//            }
//            if (i >= team1.length + name1.length + name2.length + name3.length + name4.length ) {
//               if (n52 > name5.length - 1) 
//                  n52 = name5.length - 1;
//               name_5 = name5[n52++];
//            }
//
            if (i == team1.length + name1.length + name2.length + name3.length + name4.length - 1) {
               Util.wait(100);
               if (i == team1.length - 1) 
                  Util.wait(100);
               pressEnter = "엔터키를 누르세요..";
            }

   Util.wait(150);
   System.out.println("::==========::>>> 대덕호텔 예약 키오스크 <<<::==========::");
  // System.out.print("                         "+team_1+"");
   //System.out.println("                                                       "); 
...
//   System.out.println("|                 ＼   ＼  _____／    ");
//   System.out.println("|                      ＼／ _____／     "+name_2);
 //  System.out.print(name_1 + "\t" + name_2 + "\t" + name_3 + "\t" + name_4+ "\t" + name_5);
   System.out.println("                                  ．____");
   System.out.println("                ／＼  ＼_____                                 ．_____                 ／＼_     ＼");
   System.out.println("                 ＼   ＼    ,．__＼                         ／'    ___｀＼               ＼／／＼    ＼");
   System.out.println("                      ＼    ＼  ＼ _／                       ／＼      ___／                         ＼  ＼   ＼");
   System.out.println("                           ＼  ＼  ＼_____                   ＼   ＼  ______＼                      ＼ _＼   ＼__");
   System.out.println("                                ＼  ＼  _____＼                   ＼／______／                       ／＼________＼");
...
//   System.out.println("|                             ＼／______／     "+name_4);      
//   System.out.print("");
//   System.out.println("|                          ．____             ");
//   System.out.println("|                          ／＼_     ＼");
//   System.out.println("|                           ＼／／＼    ＼     ");
...
//   System.out.println("|                                              ＼／_________／   "+name_5);
  
  // System.out.println();
 //  System.out.println(name_1 + "\t" + name_2 + "\t" + name_3 + "\t" + name_4+ "\t" + name_5);
 System.out.println();
   System.out.print("::==================================================::");
   System.out.println();
   ScanUtil.nextLine();
