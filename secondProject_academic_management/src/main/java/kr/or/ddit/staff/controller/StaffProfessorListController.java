...
@Slf4j
@WebServlet("/staff/staffProfessorList.do")
public class StaffProfessorListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 서비스를 통해 교수 리스트를 조회
		List<ProfessorVO> staffProfessorList = service.retrieveProfessorList(paging);
		...
		req.setAttribute("staffProfessorList", staffProfessorList);
		req.setAttribute("pagingHTML", pagingHTML);
		
		String logicalViewName ="staff/staffProfessorList";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try(
				...
				ProfessorVO proVO = new ObjectMapper()
										.registerModule(new JavaTimeModule())
										.readValue(is, ProfessorVO.class);
				boolean success = service.modifyProfessor(proVO);
