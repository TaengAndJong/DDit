...
<form:form id="insertForm" modelAttribute="prais" enctype="multipart/form-data">
	<input type="hidden" name="brdId" value="BN0003">
		...
		<div class="view_inner">
			<div class="view-info">
				<strong class="view-tit d-flex align-items-center">
					...
					<div class=" col-sm-11">
						<input type="text" name="bpTitle" class="form-control" placeholder="칭찬 할 사원을 입력해주세요!" value="${prais.bpTitle }">
