...
<form:form id="insertForm" modelAttribute="share" enctype="multipart/form-data">
	<input type="hidden" name="brdId" value="BN0006">
	...
	<div class="modal fade info" id="exampleModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="insertResult">"나눔글을 등록하시겠습니까?"</div>
		...
		<div class="view_inner">
			<div class="view-info">
				<strong class="view-tit d-flex align-items-center">
					...
					<div class=" col-sm-11">
						<input type="text" class="form-control" name="bpTitle" placeholder="나눔 할 물품을 입력해주세요!" value="${share.bpTitle }">
