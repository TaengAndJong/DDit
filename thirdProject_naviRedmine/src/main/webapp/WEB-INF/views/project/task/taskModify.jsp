				...
				<div id="cstmrList" data-list>
					<div class="row justify-content-end g-0">
						<div class="col-auto col-sm-5 mb-3">
							<form id="submitForm"
								action="${pageContext.request.contextPath }/task/mod/${task.taskId }"
								method="post">
...
<form id="modifyForm"
	action="${pageContext.request.contextPath }/task/mod">
	<input type="hidden" name="taskId" value="${task.taskId }"> 
<%-- 	<input type="hidden" name="taskTitle" value="${task.taskTitle }">  --%>
	<input
		type="hidden" name="taskManId" value="${task.taskManEmp.empId }">
</form>
<div class="modal fade info" id="exampleModal" tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="updateResult">"일감을 수정하시겠습니까?"</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary"
					data-bs-dismiss="modal">닫기</button>
	...
	<div class="view_inner">
		<div class="view-info">
			...
			<ul class="ul clearfix">
				...
				<li><span class="list-tit d-flex w-50  align-items-center mb-2">담당자</span>
				...
				<li><span class="list-tit">예상처리시간</span> <span
					class=" col-sm-6" aria-label="Default select example"> <input
						type="number" name="taskEstTime" class="form-control"
						value="${task.taskEstTime }">
				</span></li>
				...
				<li><span class="list-tit">마감예정일</span> <span class=" col-sm-6"
...
$(document).ready(function(){
   ...
   CKEDITOR.ClassicEditor.create(viewEdit, {
	 ...
	 $(".close").on("click",function(e){
	            		...
	            		$(this).parent().remove();
	            		fetch("${pageContext.request.contextPath}/task/file/del/"+issffId,{
							method:"POST",
							headers:{
