		...
		<div class="sub_inner clearfix">
			...
			<nav class="sub_navi tab">
				<div class="nav nav-tabs" id="nav-tab" role="tablist">
					...
					<a class ="moveMenu" data-url="${menu.rescUrl}" href="${pageContext.request.contextPath}${menu.rescUrl}">
					<button class="nav-link" id="nav${menu.rescIdx}" data-bs-toggle="tab"
...
<script src ="<c:url value='/resources/mypage/js/mypageMove.js'/>"></script>