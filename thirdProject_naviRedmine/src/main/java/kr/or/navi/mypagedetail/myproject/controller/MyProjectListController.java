package kr.or.navi.mypagedetail.myproject.controller;
...
public class MyProjectListController {
	...
	public String projectList(
		...
		// 페이지에 보여줄 프로젝트 리스트 조회
		List<ProjectVO> projectList = service.myProjectList(vo.getEmpId(), paging);
